...
<html>
  <head>
    ...
    <title>My JSP 'StUpdate.jsp' starting page</title>
  ...
  <body>
	...
	<%
		...
		if(id!=null&&student!=null&&date!=null&&money!=null){
			Consumption Consumption = new Consumption();
			Consumption.setId(Integer.parseInt(id));
   			Consumption.setMoney(Double.parseDouble(money));
   			Consumption.setDate(date);
   			Consumption.setStudent(student.getStudentId());
